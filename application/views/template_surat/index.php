<main>
    ...
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="<?php echo site_url('surat_ajuan')?>">User</a></li>
                        ...
                        foreach ($template as $suratdata) {
                            ...
                            <td>
                                <div>
                                    ...
                                    <a href=".base_url('templatesurat/delete/'.$suratdata->id)." class='btn btn-sm btn-danger' onclick='return confirm(\"Ingin menghapus data user ini ?\");'><i class='fas fa-trash'></i> Hapus</a>
